<?php
namespace Concrete\Package\MmamPackage\Theme\Mmam; //Change ThemeThemeName and ThemeName to the name of the theme folder Camel Case instead of underscore theme_name -> ThemeName
